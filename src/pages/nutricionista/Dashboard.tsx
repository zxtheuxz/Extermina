      ...
      <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-amber-200 p-3 sm:p-4 lg:p-6">
              ...
              <div className="mt-2 sm:mt-4 flex items-center">
                ...
                <span className="text-xs sm:text-sm text-green-600 truncate">+8% mês</span>
              </div>
            </div>

            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-blue-200 p-3 sm:p-4 lg:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div className="flex-1">
                  <p className="text-xs sm:text-sm font-medium text-slate-600 truncate">Aval. Masculino</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 mt-1">{stats.avaliacoesMasculinoPendentes}</p>
                </div>
              ...
              <div className="mt-2 sm:mt-4 flex items-center">
                ...
                <span className="text-xs sm:text-sm text-blue-600">Pendentes</span>
              </div>
            </div>

            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-pink-200 p-3 sm:p-4 lg:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div className="flex-1">
                  <p className="text-xs sm:text-sm font-medium text-slate-600 truncate">Aval. Feminino</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 mt-1">{stats.avaliacoesFemininoPendentes}</p>
                </div>
                <Salad className="w-6 h-6 sm:w-8 sm:h-8 text-pink-600 mt-2 sm:mt-0" />
              </div>
              <div className="mt-2 sm:mt-4 flex items-center">
                <Clock className="w-3 h-3 sm:w-4 sm:h-4 text-pink-500 mr-1" />
                <span className="text-xs sm:text-sm text-pink-600">Pendentes</span>
              </div>
            </div>


            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-green-200 p-3 sm:p-4 lg:p-6 col-span-2 sm:col-span-1">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div className="flex-1">
                  <p className="text-xs sm:text-sm font-medium text-slate-600 truncate">Taxa Adesão</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900 mt-1">{stats.taxaAdesao}%</p>
                </div>
              ...
              <div className="mt-2 sm:mt-4 flex items-center">
                ...
                <span className="text-xs sm:text-sm text-green-600 truncate">Ótimo</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 sm:mb-6">
            <div className="border-b border-gray-200">
              <nav className="-mb-px flex space-x-4 sm:space-x-8 overflow-x-auto scrollbar-hide">
                ...
                >
                  <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    {stats.avaliacoesMasculinoPendentes > 0 && (
                      <span className="ml-1 sm:ml-2 bg-blue-100 text-blue-600 text-xs font-medium px-1.5 sm:px-2 py-0.5 rounded-full">
                ...
                >
                  <div className="flex items-center gap-1 sm:gap-2">
                    <Salad className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                    ...
                    {stats.avaliacoesFemininoPendentes > 0 && (
                      <span className="ml-1 sm:ml-2 bg-pink-100 text-pink-600 text-xs font-medium px-1.5 sm:px-2 py-0.5 rounded-full">
