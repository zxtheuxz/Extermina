...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      >
        {/* Logo e título modernizado - visível apenas em desktop */}
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <img
                ...
                alt="Frango"
                className="w-12 h-12 rounded-xl shadow-lg flex-shrink-0 ring-2 ring-orange-500/20"
              />
              <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full animate-pulse"></div>
            </div>
            <div className="min-w-0 flex-1">
              <h1 className="font-bold text-lg bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent block truncate">
                EXTERMINA FRANGO
              </h1>
            ...
            <div className="flex items-center space-x-3 min-w-0">
              <div className="relative">
                <img
                  src="/images/frango.png"
                  alt="Frango"
                  className="w-10 h-10 rounded-xl shadow-lg flex-shrink-0 ring-2 ring-orange-500/20"
                />
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full animate-pulse"></div>
              </div>
              <div className="min-w-0 flex-1">
                <h1 className="font-bold text-base bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent block truncate">
                  EXTERMINA FRANGO
                </h1>
                <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'} truncate`}>
                  Menu
